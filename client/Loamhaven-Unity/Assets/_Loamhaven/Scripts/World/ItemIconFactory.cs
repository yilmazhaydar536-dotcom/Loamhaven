...
{
    // Generates and caches 16x16 item icons procedurally. Used by PlayerHeldItemRenderer.
    public static class ItemIconFactory
    {
        ...
        // 8-hue cycle so different item ids are visually distinct.
        static Color32 Palette(int id)
        {
            Color32[] p =
            {
                new Color32(180, 100,  40, 255), // wood
                new Color32(160, 160, 160, 255), // stone
                new Color32( 60, 180,  60, 255), // seed/leaf
                new Color32(220, 200,  50, 255), // grain
                new Color32(200,  60,  60, 255), // tool
                new Color32(100, 160, 220, 255), // water
                new Color32(220, 120, 200, 255), // flower
                new Color32(120, 200, 180, 255), // gem
            };
