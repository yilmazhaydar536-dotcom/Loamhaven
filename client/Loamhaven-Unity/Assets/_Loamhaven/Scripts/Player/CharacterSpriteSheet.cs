...
namespace Loamhaven.Player
{
    public static class CharacterSpriteSheet
    {
        ...
        {
            new Color32(220,  50,  50, 255),
            new Color32( 50,  80, 220, 255),
            new Color32( 50, 180,  60, 255),
            new Color32(220, 180,  40, 255),
            new Color32(160,  50, 200, 255),
            new Color32(220, 120,  30, 255),
        };
        ...
        static Sprite Build(Color32 shirt)
        {
            ...
            FillRect(px,  1, 14,  2, 7, shirt);
            FillRect(px, 13, 14,  2, 7, shirt);
            FillRect(px,  1, 12,  2, 2, Skin);
            FillRect(px, 13, 12,  2, 2, Skin);
